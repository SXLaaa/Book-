...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mpvue_router_patch__ = __webpack_require__(9);




__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_mpvue_router_patch__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.config.productionTip = false; // 关闭开发模式警告提示
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.config.lintOnSave = false; // 关闭开发模式警告提示
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ea6a293a", Component.options)
  } else {
    hotAPI.reload("data-v-ea6a293a", Component.options)
  }
